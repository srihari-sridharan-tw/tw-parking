...
3. Employee will do the following
    a. Register (signup) themselves with their employee id, vehicle id, email id, and phone number.
    b. After login (signin) to the system Check-in to a given parking slot.
    c. After login (signin) to the system Can view the list of available slots on a given day.
